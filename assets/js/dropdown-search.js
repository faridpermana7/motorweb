...
(function() { 
    ...
    function loadProvinces() {
        fetch(`${window.API_BASE_URL}/provinces`, {
            method: 'GET',
            headers: {
    ...
    districtSelect.addEventListener('change', function() {
        ...
        // Call the displayVillagesInTable function from tables.js with district ID
        if (typeof displayVillagesByDistrictId === 'function') {
            displayVillagesByDistrictId('#villagesTable', districtId);
        } else {
            console.error('displayVillagesByDistrictId function not found');
        }
    });
